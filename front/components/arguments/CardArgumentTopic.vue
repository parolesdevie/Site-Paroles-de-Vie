...
<template>
  <li
    ...
    cursor-pointer
         ${
           active
             ? 'border-black dark:bg-blue-900 dark:border-blue-700'
  ...
  >
    ...
    <div
      class="absolute inset-0 bg-black bg-opacity-10 hover:bg-opacity-40 dark:bg-opacity-20 dark:hover:bg-opacity-60 duration-300 flex items-end"
    >
      <span
